...
if (!process.env.CLOUDINARY_URL) {
     process.env.CLOUDINARY_URL="cloudinary://882133854186711:yyR3Ogz4JXUnRGkf04_oNsKLjeI@hile9esqo"
}
const doUpload = (publicId, req, res, next) => {
    ...
    //cloudinary.config({"api_key":"1234567890","cloud_name":"demo", "api_secret": "something else"});
