window.onload = function() {
    ...
    const help_text = {"name":"Your full name", "email":"Your email address",
        "phone": "Your phone number. Digits only", "birthday":"Your date of birth, must be over 16",
        "zipcode":"Zipcode, digits only", "password":"Your password, more than 6 digits","passconfirm":"Confirm your password, must be the same"}
